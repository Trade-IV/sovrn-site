  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-black text-white">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-1/2 top-1/2 h-[1000px] w-[1000px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/10 blur-3xl" />
            ...
            {services.map((service, index) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                >
                  <CardFace label={service} isHovered={isHovered} />
                </motion.button>
              );
            })}
          </div>
...
function CardFace({
  ...
  return (
    <motion.div
      ...
      className="relative h-[300px] w-[200px] overflow-hidden rounded-[26px] border-[2px] bg-white sm:h-[340px] sm:w-[220px]"
    >
      <div className="absolute inset-[4px] rounded-[20px] bg-black" />

      <div className="absolute inset-[4px] rounded-[20px] bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.08),transparent_38%)]" />

      <motion.div
        animate={{ opacity: isHovered ? 0.16 : 0.07 }}
        transition={{ duration: 0.25 }}
        className="absolute inset-[4px] rounded-[20px] bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.18),transparent_58%)]"
      />

      <div className="absolute left-[2px] top-[2px] h-[92px] w-[92px] overflow-hidden sm:left-[3px] sm:top-[3px] sm:h-[110px] sm:w-[110px]">
        <Image
          src="/logo.png"
          alt="SOVRN Logo"
          width={220}
          height={280}
          className="absolute left-[-30px] top-[-8px] h-auto w-[140px] object-contain sm:left-[-34px] sm:top-[-10px] sm:w-[165px]"
        />
      </div>

      <div className="absolute bottom-[2px] right-[2px] h-[92px] w-[92px] overflow-hidden sm:bottom-[3px] sm:right-[3px] sm:h-[110px] sm:w-[110px]">
        <Image
          src="/logo.png"
          alt="SOVRN Logo"
          width={220}
          height={280}
          className="absolute bottom-[-8px] right-[-30px] h-auto w-[140px] rotate-180 object-contain sm:bottom-[-10px] sm:right-[-34px] sm:w-[165px]"
        />
      </div>

      <div className="relative z-10 flex h-full items-center justify-center px-8">
        <p className="text-center text-lg font-medium tracking-[0.18em] text-zinc-100 sm:text-xl">
          {label}
        </p>
      </div>
    </motion.div>
          ...
          <div className="relative z-10 min-h-screen">
            <div className="flex items-start justify-between px-4 pb-4 pt-3 sm:px-6 md:px-8 md:pt-4">
              <div className="flex items-start">
                <div className="relative -ml-3 -mt-3 h-[320px] w-[240px] sm:-ml-4 sm:-mt-4 sm:h-[360px] sm:w-[270px]">
                  <Image
                    src="/logo.png"
                    alt="SOVRN Logo"
                    fill
            ...
            <div className="px-6 pb-16 pt-2 sm:px-8 md:px-12 md:pb-24">
              <div className="grid w-full gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-16">
                ...
                >
                  ...
                  <h2 className="max-w-4xl text-4xl font-semibold leading-[1.02] tracking-[-0.04em] text-zinc-100 sm:text-5xl md:text-6xl lg:text-7xl">
                    {content.title}
                  </h2>
